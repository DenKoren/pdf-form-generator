...
from typing import Optional, Union, BinaryIO, AnyStr
...
def cli_attach(form_definitions, form_name, original_document, result_document, debug):
...
@click.help_option("--help", "-h", help="Show this message and exit.")
def cli_fill(pdf_form, values_source, pdf_output):
...
cli.add_command(cli_attach)
cli.add_command(cli_fill)
